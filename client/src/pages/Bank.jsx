  ...
  const kycHandler = async ()=>{
    try {
      ...
      .then((res)=>{
        ...
        localStorage.setItem("diamSecret",res.data.secret);
      })
      console.log(localStorage.getItem("diamPublic"));
      
      await axios.post('http://localhost:5550/fund-account',{
        publicKey:localStorage.getItem("diamPublic")
      })
      .then((res)=>{
        console.log(res);
      })
