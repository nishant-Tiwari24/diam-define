...
const profile = () => {
  ...
  const renderCoupons = () => {
    return coupons.slice(0, 5).map(coupon => (
      <div key={coupon.id} className='grid-rows-4 grid justify-center'>
        <ScratchCard
                width={220}
                height={250}
                image={img}
  ...
  return (
    <div className='flex h-screen gap-3 p-7'>
        <div className='text-white flex flex-col gap-4 bg-boxbg rounded-3xl border-2 border-zinc-600 w-3/4 h-5/6'>
            <div className='border-b border-zinc-600 w-full h-1/5 p-6 flex justify-around'>
                <div className='rounded-xl border-2 border-zinc-600 p-4'> 
                ...
                <div className='flex flex-col rounded-xl border-2 border-zinc-600 p-4'> 
        ...
        <div className='flex flex-col text-white p-5 bg-boxbg rounded-xl border-2 border-zinc-600 w-1/4 h-5/6'>
            <UserProfile />
        </div>
    </div>
  );
