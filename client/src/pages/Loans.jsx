...
const Loan = () => {
  ...
  const handleProceed = async () => {
    ...
    try {
      ...
      const diam = localStorage.getItem("diam");
      alert("Paying commission of 0.01 DIAM..");
      const res = await axios.post('http://localhost:5550/make-payment',{
        senderSecret: localStorage.getItem("diamSecret"),
        receiverPublicKey: "GDGYOVIQBMQSBSOJSJTUCQCK3GCV2OZBWTX2GQVWAG2M2PFSW7YF253W",
        amount: "0.01",
      })

      console.log("running flarbitrage")
        ...
        <div className="grid grid-cols-2 gap-6 mb-8">
          <div className="bg-zinc-900 border-zinc-700 border-[1px] p-6 rounded-lg shadow-lg cursor-pointer">
            ...
            <div className='flex gap-4'>
              <p className="text-lg">DIAM pkey: {"GDGYOVIQBMQSBSOJSJTUCQCK3GCV2OZBWTX2GQVWAG2M2PFSW7YF253W".slice(0,4)} ... {"GDGYOVIQBMQSBSOJSJTUCQCK3GCV2OZBWTX2GQVWAG2M2PFSW7YF253W".slice(50,56)} </p>
              <a onClick={() => navigator.clipboard.writeText("GDGYOVIQBMQSBSOJSJTUCQCK3GCV2OZBWTX2GQVWAG2M2PFSW7YF253W")} className='mt-2'><MdContentCopy/></a>
            </div>
